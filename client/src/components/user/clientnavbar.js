...
// import logo from './whatsapp-image-20240123-at-1705-1@2x.png';
...
function ClientNavbar() {
  ...
  return (
    ...
    <ThemeProvider theme={theme}>
      ...
      <img src='/logo.png' alt="Logo" style={{ height: '88px', marginTop: '10px',marginLeft:'20px' }} />
        ...
        <AppBar position="static">
          ...
          <Toolbar>
            ...
            <Button color="inherit" component={Link} to="/clienthome">Home</Button>
          
            
            <Button color="inherit" component={Link} to="/clientprofile">Profile</Button>
            <Button color="inherit" component={Link} to="/clientquery">Query</Button>
