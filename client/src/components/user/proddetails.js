...
import { TextField, Button, FormControl, InputLabel, Select, MenuItem, Box,Toolbar,Typography } from '@mui/material';
...
const ProductForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${process.env.REACT_APP_API_URL}/api/product`, { name, code, description, category, price });
      navigate('/userlogin');
    } catch (error) {
